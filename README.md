# Kokuban 内核 for 三星 Galaxy Tab S9 系列
...
<p align="center">
<a href="https://github.com/YuzakiKokuban/android_kernel_samsung_sm8550_TabS9/releases"><img src="https://img.shields.io/github/v/release/YuzakiKokuban/android_kernel_samsung_sm8550_TabS9?style=for-the-badge&logo=github&color=blue" alt="GitHub release"></a>
...
这是一个面向 **三星 Galaxy Tab S9 系列** 的自定义内核项目，重点围绕稳定性、性能调优与日常可用性进行构建。项目当前维护 `LKM` 与 `ReSukiSU` 两种发行模式，以满足不同用户对纯净环境和高级功能的需求。
...
* **版本标识**：`-android13-Kokuban-Hutao-DZA1`
...
3. **刷入内核**：从本项目 [Releases 页面](https://github.com/YuzakiKokuban/android_kernel_samsung_sm8550_TabS9/releases) 下载对应版本，并在 Recovery 中刷入内核 `zip` 包。
...
所有最新构建版本均发布于 [**Releases 页面**](https://github.com/YuzakiKokuban/android_kernel_samsung_sm8550_TabS9/releases)。
...
# Kokuban Kernel for Samsung Galaxy Tab S9 Series
...
This is a custom kernel project for the **Samsung Galaxy Tab S9 Series**, built with a focus on stability, performance tuning, and day-to-day usability. The project currently maintains two release tracks, `LKM` and `ReSukiSU`, to serve both clean setups and advanced power-user workflows.
...
* **Version Identifier**: `-android13-Kokuban-Hutao-DZA1`
...
3. **Flash the Kernel**: Download the appropriate package from the [Releases page](https://github.com/YuzakiKokuban/android_kernel_samsung_sm8550_TabS9/releases) and flash the kernel `zip` through Recovery.
...
All current builds are published on the [**Releases Page**](https://github.com/YuzakiKokuban/android_kernel_samsung_sm8550_TabS9/releases).
